...
this["JST"]["category"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- Selected state is passed by a click event on elements with the 'selectable' class --><!-- Counts calculated from TodoList --><table><thead><tr class=\"category\" id=\""
    ...
    + "\"></img></td><td><a class=\"selectable\" href=\"#\"><h2>"
...
this["JST"]["modal"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- Modal: Todo Editor --><!-- Variables passed from Todo on TodoList --><div class=\"form\" data-id=\""
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\"><ul><li><label><span>Title</span><input id=\"title_input\" type=\"text\" value=\""
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    ...
    + "\" min=\"0\" placeholder=\"Year\" max=\"9999\"/></label></li><li class=\"textbox\"><label><span>Description</span><textarea rows=\"4\" placeholder=\"Description\">"
...
this["JST"]["subCategory"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<!-- Subcategory --><!-- Title generated from todolist --><tr class=\"category\" id=\""
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\"><td><!-- Spacer --></td><td><a class=\"selectable\" href=\"#\">"
    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
    + "</a></td><td><span>"
    + alias4(((helper = (helper = helpers.todo_count || (depth0 != null ? depth0.todo_count : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"todo_count","hash":{},"data":data}) : helper)))
    + "</span></td></tr>";
